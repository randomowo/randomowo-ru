...
class WishForm(forms.Form):
    ...
    title = forms.CharField(label_suffix="", label="Movie title ", max_length=100)
    username = forms.CharField(label_suffix="", label="\nYour username ", max_length=100)
    film_url = forms.URLField(label_suffix="", label="\nURL to kinopoisk/wiki/etc ",
                              required=False)
